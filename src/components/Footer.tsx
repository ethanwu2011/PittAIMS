        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <LogoAnimation />
              <span className="ml-2 text-xl font-semibold tracking-tight">Pitt AIMs</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/research" className="text-muted-foreground hover:text-foreground transition-colors">Research</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">NIH All of Us</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Python Tutorials</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">ML Resources</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Healthcare Datasets</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Ethics Guidelines</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-muted-foreground">
                ...
                <a href="mailto:etw46@pitt.edu" className="hover:text-foreground transition-colors">etw46@pitt.edu</a>
              </li>
              <li className="flex items-center text-muted-foreground">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
              ...
              <li className="mt-4">
                <Link to="/contact" className="text-primary hover:text-primary/90 transition-colors">
                  Contact Us
